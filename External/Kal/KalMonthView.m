    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        for (int i=0; i<6; i++) {
            for (int j=0; j<7; j++) {
                ...
                [self addSubview:[[[KalTileView alloc] initWithFrame:r tileSize:tileSize] autorelease]];
            }
        }
    }
    return self;
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextDrawTiledImage(ctx, (CGRect){CGPointZero,self.tileSize}, [[UIImage imageNamed:@"kal_tile.png"] CGImage]);
}
