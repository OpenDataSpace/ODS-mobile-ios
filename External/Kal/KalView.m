...
- (void)addSubviewsToHeaderView:(UIView *)headerView
{
    ...
    if (headerView.width > 400)
    {
        kChangeMonthButtonWidth = 68.7f;
    }
    else
    {
        kChangeMonthButtonWidth = 46.0f;
    }
    ...
    for (CGFloat xOffset = 0.f; xOffset < headerView.width; xOffset += kChangeMonthButtonWidth, i = (i+1)%7) {
        CGRect weekdayFrame = CGRectMake(xOffset, 30.f, kChangeMonthButtonWidth, kHeaderHeight - 29.f);
