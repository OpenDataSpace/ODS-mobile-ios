...
const CGSize kTileSizeDefault = { 46.0f, 44.f };
const CGSize kTileSizeIphoneLandscape = { 68.7f, 36.66f };
...
- (id)initWithFrame:(CGRect)frame logic:(KalLogic *)theLogic delegate:(id<KalViewDelegate>)theDelegate
{
    ...
    {
        self.tileSize = kTileSizeIphoneLandscape;
    }
    else
    {
        self.tileSize = kTileSizeDefault;
    }
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        frontMonthView = [[KalMonthView alloc] initWithFrame:monthRect tileSize:self.tileSize];
        backMonthView = [[KalMonthView alloc] initWithFrame:monthRect tileSize:self.tileSize];
