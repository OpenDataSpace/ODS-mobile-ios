...
- (void)uploadFinished:(NSNotification *)notification
{
    ...
    FavoriteFileDownloadManager * fileManager = [FavoriteFileDownloadManager sharedInstance];
    [fileManager updateLastDownloadDateForFilename:[fileManager newNameForFile:notifUpload.repositoryItem.title withObjectID:notifUpload.repositoryItem.guid]];
}
...
-(BOOL)updateDocument:(NSURL *)url objectId:(NSString *)objectId accountUUID:(NSString *)accountUUID
{
    ...
    if (downloadInfo) {
        ...
        success = [fileManager updateDownload:downloadInfo forKey:newName withFilePath:[url absoluteString]];
    }
