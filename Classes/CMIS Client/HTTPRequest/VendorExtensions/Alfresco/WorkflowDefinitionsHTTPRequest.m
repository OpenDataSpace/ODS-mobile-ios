 ...
 * ***** END LICENSE BLOCK ***** */
//
//  WorkflowDefinitionsHTTPRequest.m
//
...
{
    WorkflowDefinitionsHTTPRequest *request = [WorkflowDefinitionsHTTPRequest requestForServerAPI:kServerAPIWorkflowDefinitions accountUUID:uuid tenantID:tenantID];
...
- (void)requestFinishedWithSuccessResponse
{
    ...
    [[TaskManager sharedManager] enableActivitiForAccountUUID:self.accountUUID tenantID:self.tenantID enabled:activitiEnabled];
}
