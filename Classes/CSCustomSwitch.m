...
@implementation CSCustomSwitch

@synthesize on;
@synthesize tintColor, clippingView, leftLabel, rightLabel;

+(CSCustomSwitch *)switchWithLeftText:(NSString *)leftText andRight:(NSString *)rightText
{
	CSCustomSwitch *switchView = [[CSCustomSwitch alloc] initWithFrame:CGRectZero];
