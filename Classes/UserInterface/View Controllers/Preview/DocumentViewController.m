...
- (void)viewDidLoad
{
    ...
    if (self.showFavoriteButton)
    {
        ...
        if ([[FavoriteManager sharedManager] isNodeFavorite:self.cmisObjectId accountUUID:self.selectedAccountUUID tenantID:self.tenantID])
        {
...
- (IBAction)addToFavorites:(id) sender
{
    ...
    [[FavoriteManager sharedManager] favoriteUnfavoriteNode:self.cmisObjectId accountUUID:self.selectedAccountUUID tenantID:self.tenantID favoriteAction:shouldFavorite];
...
- (void)enableDocumentActionToolbarControls:(BOOL)enable allowOfflineActions:(BOOL)offlineAllowed animated:(BOOL)animated
{
    ...
    BOOL isSyncedFile = ([favoriteManager isSyncPreferenceEnabled] &&
                         [favoriteManager isNodeFavorite:self.fileMetadata.objectId accountUUID:self.selectedAccountUUID tenantID:self.tenantID]);
...
{
    BOOL documentIsFavorite = [[FavoriteManager sharedManager] isNodeFavorite:self.cmisObjectId accountUUID:self.selectedAccountUUID tenantID:self.tenantID];
