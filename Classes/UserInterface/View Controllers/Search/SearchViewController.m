...
- (void)initRepositoryWrappersWithRepositoryItems:(NSArray *)repositoryItems
{
    for(RepositoryItem *child in repositoryItems)
    {
        ...
        cellWrapper.selectedAccountUUID = selectedSearchNode.accountUUID;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if([favoriteManager isNodeFavorite:result.guid inAccount:selectedSearchNode.accountUUID] && [fileManager downloadExistsForKey:[fileManager generatedNameForFile:result.title withObjectID:result.guid]])
    {
