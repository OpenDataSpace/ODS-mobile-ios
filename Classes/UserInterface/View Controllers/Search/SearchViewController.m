...
- (void)selectDocumentAtIndexPath:(NSIndexPath *)indexPath inTableView:(UITableView *)tableView
{
    ...
    if ([favoriteManager isNodeFavorite:result.guid accountUUID:self.selectedSearchNode.accountUUID tenantID:self.selectedSearchNode.tenantID] && [fileManager downloadExistsForKey:fileName])
    {
