    ...
    if (self = [super initWithFrame:frame])
    {
        switch (color)
        {
            ...
            case SystemNoticeGradientColorYellow:
                self.gradientTop = [UIColor colorWithRed:251/255.0f green:223/255.0f blue:124/255.0f alpha:1.0]; // R: 251 G: 223 B: 124
                self.gradientBottom = [UIColor colorWithRed:240/255.0f green:204/255.0f blue:87/255.0f alpha:1.0]; // R: 240 G: 204 B: 87
                self.firstTopLine = [UIColor colorWithRed:253/255.0f green:229/255.0f blue:184/255.0f alpha:1.0]; // R: 253 G: 229 B: 184
                self.secondTopLine = [UIColor colorWithRed:253/255.0f green:229/255.0f blue:144/255.0f alpha:1.0]; // R: 253 G: 229 B: 144
                self.firstBottomLine = [UIColor colorWithRed:196/255.0f green:158/255.0f blue:46/255.0f alpha:1.0]; // R: 196 G: 158 B: 46
                self.secondBottomLine = [UIColor colorWithRed:98/255.0f green:79/255.0f blue:23/255.0f alpha:1.0]; // R: 98 G: 79 B: 23
                break;
