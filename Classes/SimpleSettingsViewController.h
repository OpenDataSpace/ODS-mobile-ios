 ...
 * ***** END LICENSE BLOCK ***** */
//
//  SimpleSettingsViewController.h
//
...
@protocol SimpleSettingsViewDelegate;

@interface SimpleSettingsViewController : IFGenericTableViewController {
    id <SimpleSettingsViewDelegate> delegate;
    
    NSString *originalUsername;
    NSString *originalPassword;
}

@property (nonatomic, assign) id <SimpleSettingsViewDelegate> delegate;
